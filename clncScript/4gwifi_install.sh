...
mkdir "$install_dir"
cd "$install_dir"
curl -o clnc.zip https://gitee.com/leapzhang/clnc/raw/master/clncScript/clnc1.0.2_4gwifi.zip || exec echo '下载clnc脚本失败'
curl -O https://gitee.com/leapzhang/clnc/raw/master/clncScript/busybox || exec echo '下载busybox程序失败'
chmod 0777 busybox
